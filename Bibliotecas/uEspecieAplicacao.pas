...
var TipoAplicacao : TTipoAplicacao;
...
function TTipoAplicacao.GeraCodigo: Integer;
var qry : TSQLQuery;
begin
  ...
  qry.SQL.Clear;
  try
    qry.SQL.Add('SELECT GEN_ID(GEN_TB_TIPOAPLICACOES_ID, 1) AS CODIGO FROM RDB$DATABASE');
